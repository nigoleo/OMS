...
/**************FilmDesign**********************
//算法：考虑SusbtrateN，N,Rate,_CurLayer,前三层的QW为模拟数据,其中前3层的QW相同材料的N与fittingN一致
**********************************************/
...
public:
    ...
    const double PenaltyLambda = 0.001;  //惩罚函数的系数
    ...
    double HN_Original;     //用于惩罚函数,可以考虑取消这个功能，改为RefWL对应的HN
    double LN_Original;     //用于惩罚函数，可以考虑取消这个功能，改为RefWL对应的LN
